...
class DistantLandscape
{
	...
	std::shared_ptr<HeightmapMeshGenerator> hGen = nullptr;
...
public:
	DistantLandscape(int _vertexCubeDimensions, glm::ivec3 pos, Heightmap& heightmapGenerator, SSBOComputeShader& genVerticies, std::shared_ptr<ThreadManager> threadManager);
	~DistantLandscape();
